...
public class SongUtils {
    ...
    /**
     * Internal Class: a Song item represents a song title, and song details.
     */
    ...
    /**
     * Method that adds an item to the array.
     *
    ...
    private static Song createSongAtPosition(int position) {
        ...
        switch (position) {
            case 0:
                ...
                song = new Song(newTitle, newDetail);
                break;
            case 1:
            ...
            case 5:
                ...
                break;
            default:
                newTitle = "One After 909 - 'Marco Sena' ";
                newDetail = "One After 909\n\nA song recorded for the Let It Be album " +
                        "was actually worked on way back in the beginning, six years earlier. " +
                        "This take shows how they did it much more slowly, with an R&B feel to it.";
                song = new Song(newTitle, newDetail);
                break;
        }
        return song; //new Song(newTitle, newDetail)
    }
}
